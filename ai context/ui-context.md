...
- **Rich text / animation / charts**: none, matching both sibling projects' stance — see `project-overview.md`'s Out of Scope. (Spec 18 briefly added `react-native-gifted-charts` for the Spending/Mileage trend tabs; spec 25 removed it per direct user instruction, restoring this stance.)
